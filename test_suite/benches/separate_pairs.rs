...
test_suite::declare_separate_pairs!(run_separate_pairs, StatefulTree);

const SEED: u64 = 123;
const N_CASES: usize = 200;
const SIZE_RANGE: Range<usize> = 20..40;
